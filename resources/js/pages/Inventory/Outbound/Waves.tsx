...
export default function Page() {
    return (
        <AppLayout breadcrumbs={[{ title: 'Inventory', href: '/inventory' }, { title: 'Wave & Batch Picking', href: '#' }]}>
            <Head title="Wave & Batch Picking" />
            <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
                <div className="flex items-center justify-center min-h-[400px] border-2 border-dashed rounded-xl bg-muted/50">
                    <div className="text-center">
                        <h2 className="text-xl font-semibold">Wave & Batch Picking Module</h2>
