...
export default function CycleCount({ counts }: PageProps) {
  return (
    <AppLayout breadcrumbs={[{ title: 'Inventory', href: '/inventory' }, { title: 'Cycle Count', href: '#' }]}>
      <Head title="Cycle Counts" />
      <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
        <div className="flex items-center justify-between">
            <h2 className="text-xl font-semibold tracking-tight">Cycle Counts</h2>
