...
import { index as invoicesIndex } from '@/routes/accounting/ar/invoices';
...
export default function InvoiceForm({ data, setData, errors, processing, customers, products, onSubmit, isEditing = false }: InvoiceFormProps) {
    const addLine = () => {
    ...
    const total = data.lines.reduce((sum: number, line: any) => sum + (parseFloat(line.subtotal) || 0), 0);
                ...
                <CardContent className="space-y-4">
                    <div className="grid grid-cols-3 gap-4">
                        <div className="space-y-2">
                            ...
                            <Select onValueChange={(val) => setData('customer_id', val)} value={data.customer_id?.toString()}>
                                <SelectTrigger>
