...
import { index, edit as editPayment } from '@/routes/accounting/vendor-payments';
import { show as showBill } from '@/routes/accounting/bills';
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        <Button variant="outline" size="sm" asChild>
                            <a href={`/accounting/vendor-payments/${payment.id}/print`} target="_blank" rel="noopener noreferrer">
                                <Printer className="mr-2 h-4 w-4" /> Print
                            </a>
                        </Button>
                        <Button variant="outline" size="sm" asChild>
                            <Link href={payment.id ? editPayment.url(payment.id) : '#'}>
                            ...
                            <CardHeader className="pb-4">
                                <div className="flex justify-between items-start">
                                    <div>
                                        ...
                                        <CardDescription>
                                            Payment to {payment.vendor?.name || 'Unknown Vendor'}
                                        </CardDescription>
                                    </div>
                                        ...
                                        {payment.lines.map((line) => (
                                            <TableRow key={line.id}>
                                                <TableCell className="pl-6">
                                                    <Link href={line.bill?.id ? showBill.url(line.bill.id) : '#'} className="text-primary hover:underline font-medium">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4 text-sm">
                                <div>
                                    <div className="font-medium">{payment.vendor?.name || 'Unknown Vendor'}</div>
