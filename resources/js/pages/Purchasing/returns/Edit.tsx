...
export default function Create({ returnData, vendors, products, warehouses }: Props) {
    ...
    return (
        <AppLayout breadcrumbs={[
            ...
            <div className="container mx-auto">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Edit Purchase Return</CardTitle>
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex justify-end gap-2">
                                ...
                                <Button type="submit" disabled={processing}>Edit Purchase Return</Button>
                            </div>
                        </form>
                    </CardContent>
                </Card>
