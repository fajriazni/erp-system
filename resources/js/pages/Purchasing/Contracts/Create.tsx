...
import { store, index } from "@/routes/purchasing/contracts"
...
export default function ContractsCreate({ vendors }: Props) {
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <PageHeader
        ...
        description="Create a new contract or purchase agreement."
      >
